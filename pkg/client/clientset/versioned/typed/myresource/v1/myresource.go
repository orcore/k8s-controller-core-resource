...
import (
	...
	scheme "github.com/orcore/k8s-controller-core-resource/pkg/client/clientset/versioned/scheme"
...
func newMyResources(c *OrcoreV1Client, namespace string) *myResources {
	return &myResources{
		client: c.RESTClient(),
		ns:     namespace,
	}
